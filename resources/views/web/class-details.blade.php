                ...
                <div class="col-lg-12">
                    <div class="class-timetable details-timetable">
                        <table>
                            <tbody>
                                <tr>
                                    <td class="class-time">{{ $producto->nombre }}<br>{{ $producto->categoria }}</td>
                                    <td class="dark-bg hover-dp ts-meta" data-tsmeta="workout">
                                        <h5>{{ $producto->dias_semana }}</h5>
                                    
                                    </td>
                                    <td class="dark-bg hover-dp ts-meta" data-tsmeta="workout">
                                        <h5>{{ $producto->hora_inicio }}</h5>
                                        <h5>{{ $producto->hora_fin }}</h5>
                                    </td>
                                    <td class="dark-bg hover-dp ts-meta" data-tsmeta="workout">
                                        <h5>{{ $producto->fecha_inicio }}</h5>
                                        <h5>{{ $producto->fecha_fin }}</h5>
                                    </td>
