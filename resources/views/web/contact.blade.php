...
<body>
    ...
    <section class="contact-section spad">
        <div class="container">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="contact-widget">
                        <div class="cw-text">
                            ...
                            <p>Alicia Moreau de Justo 1150 <br>Piso 3 Oficina 306-A<br> Buenos Aires<br/></p>
                        </div>
                        <div class="cw-text">
                        ...
                        <div class="cw-text email">
                            <a href= "https://www.mercadopago.com.ar"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                            <p>Realiza tu pago!</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="leave-comment">
                        <form action="#" method="POST">
                            ...
                            <input type="email" id="txtCorreo" name="txtCorreo" placeholder="Email" required>
                            <textarea id="txtComentario" name="txtComentario" placeholder="Comentario" required></textarea>
            ...
            <div class="map">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3283.7309687317825!2d-58.368290984770184!3d-34.610963880457604!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bccacd84dda1b3%3A0xd9ca67810e463201!2sDePCsuite!5e0!3m2!1ses-419!2sar!4v1589411328334!5m2!1ses-419!2sar" height="550" style="border:0;" allowfullscreen=""></iframe>
            </div>
        </div>
    </section>
    <!-- Contact Section End -->
