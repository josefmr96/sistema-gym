            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="nav-menu">
                        ...
                        <li><a href="/">Home</a></li>
                        <li><a href="/nosotros">Nosotros</a></li>
                        <li class="active"><a href="./clases">Clases</a></li>
                        <li><a href="/servicios">Servicios</a></li>
                        <li><a href="/entrenadores">Entrenadores</a></li>
                        <li><a href="/contacto">Contacto</a></li>
                        </ul>
                        ...
                        <div class="cd-trainer">
                            <div class="row">                       
                                <div class="col-md-6">
                                    ...
                                    <img src="/images/{{ $entrenador->foto }}"  style="width:100px"  alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="cd-trainer-text">
                                        <div class="trainer-title">
                                            <h4>{{ $entrenador->nombre or ''}} </h4>
                                        ...
                                        <ul class="trainer-info">
                                            <li><span>Peso:</span>{{$entrenador->identrenador = $entrenador->peso}} </li>
                                            <li><span>Altura:</span>{{$entrenador->identrenador = $entrenador->altura}} </li>
                                            <li><span>Especialidad:</span>{{$entrenador->identrenador = $entrenador->especialidad}} </li>
                                        </ul>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor incididunt ut labore et dolore magna aliqua viverra maecenas lacus
                                            vel facilisis. </p>
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="sidebar-option">
                        ...
                        <div class="so-latest">
                            ...
                            <div class="latest-large set-bg" data-setbg="/web/img/letest-blog/latest-1.jpg">
                                <div class="ll-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="/web/img/letest-blog/latest-2.jpg" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="/web/img/letest-blog/latest-3.jpg" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="/web/img/letest-blog/latest-4.jpg" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="/web/img/letest-blog/latest-5.jpg" alt="">
                                </div>
                                <div class="li-text">
