...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/admin/producto/categorias">Categorias</a></li>
    <li class="breadcrumb-item active">Modificar</li>
</ol>
<ol class="toolbar">
    <li class="btn-item"><a title="Nuevo" href="/admin/producto/categorias/nuevo" class="fa fa-plus-circle" aria-hidden="true"><span>Nuevo</span></a></li>
...
<script>
function fsalir(){
    location.href ="/admin/producto/categorias/nuevo";
}
</script>
@endsection
@section('contenido')
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select id="lstCategoriaPadre" name="lstCategoriaPadre" class="form-control">
                        ...
                        @for ($i = 0; isset($array_categorias) && $i < count($array_categorias); $i++)
                            @if (isset($categoria) and $array_categorias[$i]->idcategoria == $categoria->fk_idcategoriapadre)
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="{{$categoria->descripcion or ''}}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Foto: *</label>
