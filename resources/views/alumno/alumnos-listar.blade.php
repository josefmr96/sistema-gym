...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="#" class="fa fa-refresh" aria-hidden="true" onclick='window.location.replace("/admin/alumno/alumnos");'><span>Recargar</span></a></li>
</ol>
@endsection
@section('contenido')
<?php
...
<script>
	var dataTable = $('#grilla').DataTable({
        ...
        "pageLength": 25,
        "order": [[ 0, "asc" ]],
	    "ajax": "{{ route('alumnos.cargarGrilla') }}"
	});
</script>
@endsection